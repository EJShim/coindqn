...
if __name__ == "__main__":
    ...
    # Create Q functions
    Q = Q_net(state_space=env.observation_space.shape[0],  action_space=env.action_space.n).to(device)
    Q_target = Q_net(state_space=env.observation_space.shape[0],  action_space=env.action_space.n).to(device)
    ...
    for i in range(episodes):
        ...
        if i % print_per_iter == 0 and i!=0:
            ...
            save_path = f"output/{env_name}/{model_name}_{exp_num}_{i}.pth"
